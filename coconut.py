...
def compare_prices(product_laughs,product_glomark):
    #DONE: Aquire the web pages which contain product Price

    laughs_res = requests.get(product_laughs)
    
    #DONE: LaughsSuper supermarket website provides the price in a span text.
    ...
    #DONE: Glomark supermarket website provides the data in jason format in an inline script.
    ...
    #DONE: Parse the values as floats, and print them.
